...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 26, 2021 at 02:05 AM
...
CREATE TABLE IF NOT EXISTS `cart` (
  ...
  `Loyalty_Point_Discount` double DEFAULT NULL,
...
(2, 'nileshshermal007@gmail.com ', 3, 2, 20, 50, 5950),
(3, 'ravindursm1@gmail.com', 4, 1, 30, 50, 6950),
(4, 'sanojan11@gmail.com', 2, 3, 40, 50, 7950),
(5, 'tharindudk7714@gmail.com', 2, 4, 50, 50, 8950),
(6, NULL, NULL, NULL, 1, NULL, 4100),
(7, NULL, NULL, NULL, 1, NULL, 4000),
(8, NULL, NULL, NULL, 11, NULL, 44000);
...
('rav@gmail.com', 'rsm', 'Ravindu', 'Shehan', 'Seeduwa', 'lk', '11410', '+94723518965'),
('ravi12@gmail.com', 'rsm', 'Ravindu', 'Sathsara', 'Seeduwa', 'lk', '11410', '+94723696425'),
...
INSERT INTO `cus_order` (`Order_ID`, `Cart_ID`, `C_Email`, `C_Name`, `To_Address`, `To_Country`, `To_State`, `To_ZipCode`, `Order_Date`, `TP`) VALUES
...
(10, 8, 'rav@gmail.com', 'ravi', 'Seeduwa', 'lk', 'gampaha', '11410', '2020-11-30 02:23:44', '+9472351835');
...
(47, 'ravi@gmail.com', 'Complain', '2020-11-29', 'testing', 'uploads/Screenshot (44).png'),
(48, 'ravindursm1@gmail.com', 'Help', '2020-12-02', 'final', 'uploads/Screenshot (1).png');
...
(1, 100, 'NSE Cinnamon oil', 'Cinnamon-oil', 1, 'Good Quality', 5000, '2020-10-07', '2020-10-15', 10, 4500, 1, 'Images/Spice1.jpg'),
(1, 100, 'NSE Cinnamon Oil', 'Cinnamon-oil', 2, 'Good Quality', 6000, '2020-10-07', '2020-10-31', 0, 0, 0, ''),
(2, 250, 'NSE Cinnamon Bark', 'Cinnamon-Bark', 3, 'Best Quality', 4000, '2020-10-02', '2020-10-31', 0, 0, 0, 'Images/spice2.jpg'),
(2, 300, 'NSE Cinnamon Bark', 'Cinnamon-Bark', 4, 'Export Quality', 8000, '2020-10-02', '2020-10-31', 0, 0, 0, ''),
(3, 500, 'Cinnomon', 'A', 5, 'Sticks', 1000, '2020-11-19', '2021-01-31', 0, 0, 0, 'Images/Report_Cinnamon.jpg'),
(4, 1000, 'Spice', 'B', 6, 'Powder', 500, '2020-11-19', '2021-02-28', 15, 425, 1, 'Images/spice3.jpg'),
(5, 400, 'Spray', 'C', 7, 'Cinnamon Aroma Spray', 100, '2020-11-16', '2021-01-31', 10, 90, 1, 'Images/spice4.jpg');
...
CREATE TABLE IF NOT EXISTS `productreview` (
  ...
  `C_Name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
(17, 4, NULL, 'ravindursm1@gmail.com', '2020-12-01', 'good quality', NULL);
...
(5, 3, 'A', 1, 500, '2020-11-19', '2021-01-31'),
(6, 4, 'B', 1, 1000, '2020-11-19', '2021-02-28'),
(7, 5, 'C', 1, 400, '2020-11-18', '2021-01-31');
